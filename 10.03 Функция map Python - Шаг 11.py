...
Значения из списка list_x должны подставляться в переменную x, из списка list_y - в переменную y и
из списка list_w - в переменную w.
...
[9211, 480496, -2219, 181819, 5304420, 39916, 3418165, 1344, 66532, 63568, 2795821, 3424415, 549025, 19521, 12091,
12196, -1031, 931, 749, 6321, 812761, 719663, 12061, 72769, 883477, 930286, 456208, 2085061, 2085000, 84304, 1493825,
61759, 1494586, 10424, 397471, 3105621, 826975, 9496, 182001, 158976, 52000, 169, 734431, 833275, 193860, 28765, 563121,
194833, 107293, 463984]
"""
