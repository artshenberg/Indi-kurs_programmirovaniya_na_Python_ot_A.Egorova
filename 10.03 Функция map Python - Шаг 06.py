...
def from_hex_to_rgb(color: str) -> tuple:
    """
    Принимает на вход строку - закодированный код цвета в формате HEX и возвращает кортеж из трех значений
    (оттенок_красного, оттенок_зеленого, оттенок_синего) - формат RGB.
    :param color: Строка вида '#B22222'
    :return: (оттенок_красного, оттенок_зеленого, оттенок_синего)
    """

    return tuple([int(str(i), base=16) for i in [color[1:3], color[3:5], color[5:]]])
