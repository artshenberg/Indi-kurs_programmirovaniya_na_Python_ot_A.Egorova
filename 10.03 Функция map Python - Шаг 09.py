"""
Перед вами имеется список словарей persons. Изучите внимательно все элементы списка, у них имеется одинаковый набор
ключей. Ваша задача на основании списка persons отобрать информацию о номерах телефона и сложить их в отдельный список
phones. Номера в списке phones должны располагаться в том же порядке, в котором расположены их владельцы в списке
persons.
...
['680-436-8521x3468', '602.518.4130', '691-498-5303x079', '(471)195-7189', '001-098-434-5950x276',
'+1-018-070-2288x18433', '2930693269', '8643048473', '+1-583-428-7663', '714-879-5250']
"""
