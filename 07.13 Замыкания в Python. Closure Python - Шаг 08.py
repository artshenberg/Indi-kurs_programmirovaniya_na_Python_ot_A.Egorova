"""
Ваша задача создать функцию-замыкание create_dict, она должна сохранять в себе все значения, которые ей будут переданы
причем в виде словаря. Ключами данного словаря должны быть натуральные числа, равные номеру вызова данной функции.
...
def create_dict():
    """Сохраняет в себе в виде словаря все значения, которые ей переданы."""
    saver = {}

    def inner(*args):
        nonlocal saver
        for item in args:
            saver[len(saver) + 1] = item
